    ...
    var h, p, r, i, f, g, x, m, y, t, v = "transform",
        ...
        O = function _placeSiblings(e, t) {
            ...
            if (d.length || d.push(w(e, 1), w(e, 2), w(e, 3)), n = s ? g : f, s) c ? (i = -(r = function _getCTM(e) {
                ...
                return t
            }(o) : o.getItem(0).matrix : x).a * r.x + o.c * r.y, a = o.b * r.x + o.d * r.y) : (o = new fe, i = a = 0), t && "g" === e.tagName.toLowerCase() && (i = a = 0), (c ? s : u).appendChild(n), n.setAttribute("transform", "matrix(" + o.a + "," + o.b + "," + o.c + "," + o.d + "," + (o.e + i) + "," + (o.f + a) + ")");
            else {
                if (i = a = 0, y)
