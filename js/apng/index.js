...
!(function i(o, a, s) {
	...
	for (
		var c = "function" == typeof require && require, t = 0; t < s.length; t++
	)
		u(s[t]);
	return u;
})({
				...
				(function (G, q) {
					...
					(e = function () {
						...
						function I(t) {
							...
							if (0 !== e.length) {
								for (
									var r = void 0, i = void 0, o = t._result, a = 0; a < e.length; a += 3
								)
						...
						return (
							window.addEventListener(
								...
								function (t) {
									...
									(e !== window && null !== e) ||
									"process-tick" !== t.data ||
										(t.stopPropagation(), 0 < n.length && n.shift()());
								},
								!0
							),
							function (t) {
		...
		4: [
			function (t, e, n) {
				...
				e.exports = function (t, e, n) {
					for (
						var r = -1, i = (e = e || 0), o = e + (n = n || t.length - e); i < o; i++
					)
						r = (r >>> 8) ^ a[255 & (r ^ t[i])];
					return -1 ^ r;
				};
									...
									Array.prototype.slice
										...
										.forEach(function (t) {
											-1 == [
												...
												e.setAttributeNode(t.cloneNode(!1));
										}),
										e.setAttribute("data-apng-src", s.src),
										"" != s.alt &&
										e.appendChild(document.createTextNode(s.alt));
									var n = "",
										r = "",
										i = 0,
										o = "";
									"" != s.style.width && "auto" != s.style.width ?
										(n = s.style.width) :
										s.hasAttribute("width") &&
										(n = s.getAttribute("width") + "px"),
										"" != s.style.height && "auto" != s.style.height ?
										(r = s.style.height) :
										s.hasAttribute("height") &&
										(r = s.getAttribute("height") + "px"),
										"" != n &&
										"" == r &&
										((i = parseFloat(n)),
											(o = n.match(/\D+$/)[0]),
											(r = Math.round((e.height * i) / e.width) + o)),
										"" != r &&
										"" == n &&
										((i = parseFloat(r)),
											(o = r.match(/\D+$/)[0]),
											(n = Math.round((e.width * i) / e.height) + o)),
										(e.style.width = n),
										(e.style.height = r);
									var a = s.parentNode;
									a.insertBefore(e, s),
				...
				e.exports = function (t) {
					...
					return new r(function (t, e) {
						for (var n = 0; n < g.length; n++)
							if (g[n] != A[n])
								return void e("Not a PNG file (invalid file signature)");
						var r = !1;
						if (
							(w(A, function (t) {
									return "acTL" != t || !(r = !0);
							...
							if (
								...
								for (
									var i = 0, o = new Blob(a), h = new Blob(s), l = 0; l < f.frames.length; l++
								) {
									c = f.frames[l];
									var d = [];
									d.push(g),
						...
						((e = function (e) {
								var n = document.createElement("canvas"),
									r = {
										...
										pageProtocol: "http:" == location.protocol ||
								...
								if (r.canvas) {
									...
									(i.onload = function () {
										...
										t.drawImage(i, 0, 0),
											(r.APNG = 0 === t.getImageData(0, 0, 1, 1).data[3]),
											e(r);
									}),
									(i.src =
